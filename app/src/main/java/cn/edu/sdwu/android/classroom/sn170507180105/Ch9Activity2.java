...
public class Ch9Activity2 extends AppCompatActivity {
    ...
    private HashMap product;//key表示类别，val表示多个商品
    @Override
    ...
    class MyAdapter extends BaseExpandableListAdapter{
        ...
        public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
            ...
            if(view==null){
                LayoutInflater layoutInflater=getLayoutInflater();
                layoutInflater.inflate(R.layout.layout_goods,null);
            }
            //设置展示产品的内容
            String cat=category.get(i).toString();
            ...
            ImageView imageView=(ImageView)findViewById(R.id.goods_jub);
            imageView.setImageResource(R.drawable.jub);
            return view;
        }
    ...
    private void initDate(){
        ...
        map.put("price","60");
        list.add(map);
        product.put("category1",list);//第一个类别，两种商品
        ...
        map.put("price","70");
        list.add(map);
        product.put("category2",list);//第二个类别，三种商品
        ...
        map.put("price","50");
        list.add(map);
        product.put("category3",list);//第三个类别，一种商品
